...
namespace EasyBuildSystem.Packages.Addons.CircularBuildingMenu
{
    public class UICircularBuildingMenu : Singleton<UICircularBuildingMenu>
    {
        ...
        {
            GameObject go = BuildingManager.Instance.GetBuildingPartByName(buildingName).gameObject;
            GlobalItemDescription.Instance.ShowRecipe(buildingName, go);
        }

        public void SelectBuildingPartCraft(string buildingName)
        {
