...
public class BasicBehaviourMobile : MonoBehaviour
{
	...
	void Update()
	{
        ...
        Vector3 movementDirection = cameraForward.normalized;

        // Apply movement input to the character
        Vector3 movement = (movementDirection * v + Camera.main.transform.right * h).normalized;

        GetRigidBody.velocity = movement * 9f;
	...
	public bool IsGrounded()
	{
		...
		return Physics.SphereCast(ray, colExtents.x, colExtents.x + 0.5f);
	}
}
